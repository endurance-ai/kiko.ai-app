...
const nextConfig: NextConfig = {
  ...
  images: {
    remotePatterns: [
      ...
      // 상품 이미지 원본 호스트 (운영 products.image_url 기준 상위 소스)
      { protocol: "https", hostname: "cdn.shopify.com" },
      { protocol: "https", hostname: "static.zara.net" },
      { protocol: "https", hostname: "**.imweb.me" },
      { protocol: "https", hostname: "**.sixshop.com" },
      { protocol: "https", hostname: "**.sixshop.io" },
      { protocol: "https", hostname: "image.uniqlo.com" },
      { protocol: "https", hostname: "yearsago.kr" },
      { protocol: "https", hostname: "cayl.co.kr" },
      { protocol: "https", hostname: "**.thepinkmall.com" },
      { protocol: "https", hostname: "etce.kr" },
      { protocol: "https", hostname: "unaffected.co.kr" },
      { protocol: "https", hostname: "**.monday-edition.co.kr" },
      { protocol: "https", hostname: "autumnshop.kr" },
      { protocol: "https", hostname: "dunststudio.com" },
      { protocol: "https", hostname: "kindersalmon.com" },
      { protocol: "https", hostname: "oheshio.com" },
      { protocol: "https", hostname: "nomanual-shop.com" },
      { protocol: "https", hostname: "sculptorpage.com" },
      // 편집샵/브랜드몰
